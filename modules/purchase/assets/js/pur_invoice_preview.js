...
function change_status_pur_invoice (invoker,id){
  "use strict"; 
   $.post(admin_url+'purchase/change_status_pur_invoice/'+invoker.value+'/'+id).done(function(reponse){
    reponse = JSON.parse(reponse);
    window.location.href = admin_url + 'purchase/purchase_invoice/'+id;
