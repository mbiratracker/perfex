              ...
              <div class="row">
                <div class="col-md-12 form-group">
                  <label for="send_to"><span class="text-danger">* </span><?php echo _l('send_to'); ?></label>
                    <select name="send_to[]" id="send_to" class="ajax-sesarch" required multiple="true"  data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>" >
      ...
      <div class="modal-content modal_withd">
          ...
          <div class="modal-body">
              ...
              <div class="row">
                ...
                <div id="send_to_vendors_div" class="col-md-12 form-group">
