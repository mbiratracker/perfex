    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="panel-body">
          ...
          <div class="tab-content">
             <div role="tabpanel" class="tab-pane ptop10 <?php if($this->input->get('tab') != 'discussion' && $this->input->get('tab') != 'attachment'){echo 'active';} ?>" id="general_infor">
              <div class="row">
                <?php if($pur_order->order_status == 'new' && is_vendor_logged_in()){ ?>
                  <div class="col-md-12">
                    <a href="javascript:void(0)" onclick="confirm_order(this); return false;" class="btn btn-info pull-right" data-order_id="<?php echo pur_html_entity_decode($pur_order->id); ?>" data-toggle="tooltip" data-placement="top" title="<?php echo _l('pur_confirm_order_note'); ?>"><?php echo _l('pur_confirm'); ?></a>
                    </div>
                  <?php } ?>
               ...
               <div class="col-md-6">
                  ...
                  <table class="table table-striped table-bordered">
                    <tr>
                      ...
                      <td><?php echo pur_html_entity_decode($pur_order->pur_order_number) ?></td>
                    </tr>
                    <tr>
                      <td><?php echo _l('pur_order_name'); ?></td>
                      <td><?php echo pur_html_entity_decode($pur_order->pur_order_name) ?></td>
                    </tr>
                    <tr>
              ...
              <?php } else { ?>
                  ...
                  <tbody>
                      <?php foreach($files as $file){ ?>
                        <?php if($file['visible_to_vendor'] == 1 || $file['contact_id'] == get_vendor_contact_user_id()){ ?>
                            <tr>
                                <td>
                                  <?php
                                ...
                                ?>
                                <a href="<?php echo site_url('purchase/vendors_portal/download_file/pur_order/'.$file['id']); ?>" target="_blank" download
        ...
        <div class="row">
          ...
          <?php if($pur_order->currency_rate != 1){ ?>
            <div class="col-md-12">
            <span class="label label-default pull-right btn"><?php echo _l('currency_rate').': '; ?><?php echo pur_html_entity_decode($pur_order->currency_rate); ?></span>
          </div>
          <?php } ?>
        <div class="col-md-12">
           ...
           <table class="table text-right">
               <tbody>
                  <tr id="subtotal">
                     ...
                     <td class="subtotal">
                        <?php echo app_format_money($pur_order->subtotal,$base_currency->name); ?>
                     </td>
                  </tr>
                  ...
                  <tr id="subtotal">
                     ...
                     <td class="subtotal">
                        <?php echo '-'.app_format_money(($pur_order->discount_total + $item_discount), $base_currency->name); ?>
                     </td>
                  </tr>
                  <?php } ?>
                  ...
                  <?php if($pur_order->shipping_fee > 0){ ?>
                      <tr id="subtotal">
                        ...
                        <td class="subtotal">
                          <?php echo app_format_money($pur_order->shipping_fee, $base_currency->name); ?>
                        </td>
                      </tr>
                    <?php } ?>
                  ...
                  <tr id="subtotal">
                     ...
                     <td class="subtotal bold">
                        <?php echo app_format_money($pur_order->total, $base_currency->name); ?>
                     </td>
                  </tr>
               </tbody>
            </table>
         ...
         <?php if($pur_order->vendornote != ''){ ?>
           <div class="col-md-12 mtop15">
              ...
              <p><?php echo nl2br($pur_order->vendornote); ?></p>
           </div>
           <?php } ?>
           ...
           <div class="col-md-12 mtop15">
              ...
              <p><?php echo pur_html_entity_decode($pur_order->terms); ?></p>
           </div>
           <?php } ?>
