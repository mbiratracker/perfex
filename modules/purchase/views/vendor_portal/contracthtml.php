            ...
            <div role="tabpanel" class="tab-pane<?php if(!$this->input->get('tab') || $this->input->get('tab') === 'summary'){echo ' active';} ?>" id="summary">
               ...
               <?php if($contract->signed == 1){ ?>
                  <div class="row mtop20">
                     ...
                     <?php if(file_exists(PURCHASE_MODULE_UPLOAD_FOLDER.'/vendor_sign/'.$contract->id.'/signature.png')){ ?>
               ...
               <?php if($contract->signed_status == 'signed'){ ?>
                  <div class="row mtop20">
                     ...
                     <?php if(file_exists(PURCHASE_MODULE_UPLOAD_FOLDER.'/contract_sign/'.$contract->id.'/signature.png')){ ?>
                        <div class="col-md-12 mbot15">
                     ...
                     <div class="col-md-7 contract-contract-signed-by">
                        <?php echo get_staff_full_name($contract->signer); ?>
                     </div>
                     <div class="col-md-5 text-muted contract-signed-by">
                        <?php echo _l('contract_signed_date'); ?>
                     </div>
