			...
			<div class="panel-body">
		        ...
		        <div class="tab-content">
             		<div role="tabpanel" class="tab-pane ptop10 <?php if($this->input->get('tab') != 'discussion' && $this->input->get('tab') != 'attachment'){echo 'active';} ?>" id="general_infor">
                        ...
                        <span class="label label-default pull-right btn"><?php echo _l('currency_rate').': '; ?><?php echo pur_html_entity_decode($pur_invoice->currency_rate); ?></span></div>
                       <?php } ?>
						<div class="col-md-12 pad_left_0 pad_right_0">
		                      ...
		                      <?php foreach($files as $file){ ?>
		                        <?php if($file['visible_to_vendor'] == 1 || $file['contact_id'] == get_vendor_contact_user_id()){ ?>
		                            <tr>
		                                ...
		                                $href_url = site_url(PURCHASE_PATH.'pur_invoice/'.$file['rel_id'].'/'.$file['file_name']).'" download';
		                                ...
		                                ?>
		                                <a href="<?php echo site_url('purchase/vendors_portal/download_file/pur_invoice/'.$file['id']); ?>" target="_blank" download
		                    ...
		                    <td data-order="<?php echo $file['dateadded']; ?>"><?php echo _dt($file['dateadded']); ?></td>
		                        ...
		                        <td>
		                            <?php if($file['contact_id'] == get_vendor_contact_user_id()){ ?>
		                                <a href="<?php echo site_url('purchase/vendors_portal/delete_pi_file/'.$file['id'].'/'.$pur_invoice->id); ?>"
