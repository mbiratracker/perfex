	...
	<div class="col-md-12">
		<div class="panel_s">
			<div class="panel-body">
				...
				<hr class="mtop5">
				<?php if(get_option('allow_vendor_add_edit_delete_purchase_invoice') == 1){ ?>
				...
				<table class="table dt-table">
			      ...
			      <tbody>
			         ...
			         <tr class="inv_tr">
			         	...
			         	<td class="inv_tr"><?php echo app_format_money($inv['subtotal'],$base_currency->name); ?></td>
			         	<td class="inv_tr"><?php echo app_format_money($inv['tax'],$base_currency->name); ?></td>
			         	<td class="inv_tr"><?php echo app_format_money($inv['total'],$base_currency->name); ?></td>
			         	<td class="inv_tr"><?php 
			         	$class = '';
