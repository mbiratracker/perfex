    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="tab-content">
          ...
          <div class="row">
            <div class="col-md-12">
              <?php if(get_option('allow_vendor_add_edit_delete_purchase_quotation') == 1){ ?>
             ...
             <div class="col-md-6">
                <table class="table table-striped table-bordered">
                  ...
                  <tr>
                    ...
                    <td><?php echo pur_html_entity_decode($pur_request->pur_rq_name); ?></td>
                  </tr>
                  <tr>
             ...
             <div class="col-md-6">
                <table class="table table-striped table-bordered">
                  <tr>
                    <td width="30%"><?php echo _l('date_request'); ?></td>
