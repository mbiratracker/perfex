...
<table class="table dt-table">
 <thead>
    ...
    <th><?php echo _l('prefix_for_vendor_code'); ?></th>
 ...
 <tbody>
  <?php foreach($vendor_categories as $vc){ ?>
    <tr>
      ...
      <td><?php echo pur_html_entity_decode($vc['code_prefix']); ?></td>
      <td><?php echo pur_html_entity_decode($vc['description']); ?></td>
      <td>
        <a href="#" onclick="edit_vendor_cate(this,<?php echo pur_html_entity_decode($vc['id']); ?>); return false" data-name="<?php echo pur_html_entity_decode($vc['category_name']); ?>" data-description="<?php echo pur_html_entity_decode($vc['description']); ?>" data-code_prefix="<?php echo pur_html_entity_decode($vc['code_prefix']); ?>" class="btn btn-default btn-icon"><i class="fa fa-pencil-square"></i></a>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                     ...
                     <div class="form">
                        <label for="category_name"><span class="text-danger">* </span><?php echo _l('name') ?></label>
                        <?php echo render_input('category_name', '', '', 'text', ['required' => 'true']); ?>

                        <?php echo render_input('code_prefix', 'prefix_for_vendor_code', '', 'text', ['required' => 'true']); ?>
