...
<table class="table dt-table">
	...
	<?php foreach($approval_setting as $value){ ?>
		<tr>
		   ...
		   <td>
		     <a href="#" onclick="edit_approval_setting(this,<?php echo pur_html_entity_decode($value['id']); ?>); return false" data-name="<?php echo pur_html_entity_decode($value['name']); ?>" data-related="<?php echo pur_html_entity_decode($value['related']); ?>" data-approval_type="<?php echo pur_html_entity_decode($value['approval_type']); ?>" data-setting='<?php echo pur_html_entity_decode($value['setting']); ?>' class="btn btn-default btn-icon"><i class="fa fa-pencil-square"></i></a>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<?php $related = [ 
								...
								4 => ['id' => 'purchase_invoice', 'name' => _l('pur_invoice')],
								5 => ['id' => 'faf_requests', 'name' => _l('pur_faf_requests')],
							]; ?>
