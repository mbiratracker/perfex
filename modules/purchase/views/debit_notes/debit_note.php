     ...
     <div class="panel-body">
      ...
      <div class="row">
       ...
       <label for="vendorid"><?php echo _l('vendor'); ?></label>
        <select name="vendorid" id="vendorid" class="ajax-search" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>" >
            

               <?php
                  if(isset($debit_note)) {
                      $rel_data = get_relation_data('vendors', $debit_note->vendorid);
