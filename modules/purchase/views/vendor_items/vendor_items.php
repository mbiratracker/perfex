          ...
          <div class="panel-body">
            ...
            <div class="row">
              <div class="col-md-12 form-group">
                    ...
                    <select name="vendor[]" id="vendor" class="ajax-sesarch" multiple="true" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>" >
