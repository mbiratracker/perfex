          ...
          <div class="panel-body">
            ...
            <div class="row">
              <div class="col-md-3 form-group">
                ...
                <label for="vendor_filter"><?php echo _l('vendors'); ?></label>
                    <select name="vendor_filter" id="vendor_filter" class="ajax-sesarch" multiple="true"  data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>" >
              ...
              <div class="modal-dialog" role="document">
                 <div class="modal-content">
                    ...
                    <div class="modal-body">
                       <?php if(is_admin() || has_permission('purchase_vendor_items', '', 'delete')){ ?>
                    ...
                    <div class="modal-footer">
                       ...
                       <?php if(has_permission('purchase_vendor_items','','delete') || is_admin()){ ?>
