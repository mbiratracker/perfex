               ...
               <div class="col-md-6">
                  ...
                  <div class="row">
                     <div class="col-md-3 pad_right_0">
                        ...
                        <?php 
                        $vendor_code_prefix = ( isset($client) ? $client->vendor_code_prefix : '');
                        echo render_select('vendor_code_prefix', $prefix_codes, array('id', 'name'), 'vendor_code_prefix', $vendor_code_prefix); ?>
                     </div>
                     <div class="col-md-9">
