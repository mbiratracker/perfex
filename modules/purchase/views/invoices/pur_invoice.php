            ...
            <div class="row">
            	...
            	<div class="col-md-6">
	                ...
	                <div class="col-md-6 pad_left_0 form-group">
	                    ...
	                    <select name="vendor" id="vendor" class="ajax-search" onchange="pur_vendor_change(this); return false;" required="true" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>">
	                       
	                        <?php
                            if(isset($pur_invoice)) {
                                $rel_data = get_relation_data('vendors', $pur_invoice->vendor);
