...
<div id="wrapper">
  <div class="content">
    <div class="row">
      <div class="col-md-12">
        <div class="panel_s">
        	<?php if((debits_can_be_applied_to_invoice($pur_invoice->payment_status) && $debits_available > 0) && $pur_invoice->approval_status == 2) { ?>
             ...
             <div class="col-md-12">
              <h4 class="no-margin font-bold"><?php echo _l($title); ?> </h4>
	            ...
	            <div class="horizontal-tabs">
	         	...
	         	<div class="row">
	         		<div class="col-md-3">
	         			<?php echo get_status_approve($pur_invoice->approval_status); ?>
	         			<?php $class = '';
	         			...
	         			<div class="visible-xs">
		                  <div class="mtop10"></div>
		               	...
		               	<div class="pull-right">
                            ...
                            <?php if($pur_invoice->approval_status != 2 && has_permission('purchase_invoices', '', 'edit') && count($list_approve_status) == 0){ ?>
			               		<a href="<?php echo admin_url('purchase/pur_invoice/'.$pur_invoice->id); ?>" data-toggle="tooltip" title="<?php echo _l('edit_invoice'); ?>" class="btn btn-default btn-with-tooltip  mleft5" data-placement="bottom"><i class="fa fa-pencil-square"></i></a>
			               	<?php } ?>
			               	<?php if($pur_invoice->approval_status == 2){ ?>	
			               	   <?php if(purinvoice_left_to_pay($pur_invoice->id) > 0){ ?>
				               	<a href="#" onclick="add_payment(<?php echo pur_html_entity_decode($pur_invoice->id); ?>); return false;" class="btn btn-success pull-right mleft5"><i class="fa fa-plus-square"></i>&nbsp;<?php echo ' '._l('payment'); ?></a>
				               <?php } ?>
				           <?php } ?>
		               	</div>
		               	<?php if(has_permission('purchase_invoice_change_approve_status', '', 'edit')){ ?>     
				               <select name="status" id="status" class="selectpicker pull-right" onchange="change_status_pur_invoice(this,<?php echo ($pur_invoice->id); ?>); return false;" data-live-search="true" data-width="20%" data-none-selected-text="<?php echo _l('pur_change_status_to'); ?>">
				                 <option value=""></option>
				                 <option value="1" class="<?php if($pur_invoice->approval_status == 1) { echo 'hide';}?>"><?php echo _l('purchase_draft'); ?></option>
				                 <option value="2" class="<?php if($pur_invoice->approval_status == 2) { echo 'hide';}?>"><?php echo _l('purchase_approved'); ?></option>
				                 <option value="3" class="<?php if($pur_invoice->approval_status == 3) { echo 'hide';}?>"><?php echo _l('pur_rejected'); ?></option>
				                 <option value="4" class="<?php if($pur_invoice->approval_status == 4) { echo 'hide';}?>"><?php echo _l('pur_canceled'); ?></option>
				               </select>
				             <?php } ?>
	         	...
	         	<div class="tab-content">
	         		<div role="tabpanel" class="tab-pane ptop10 active" id="tab_pur_invoice">
	         			<div class="col-md-6 pad_left_0">
	         				...
	         				<div class="col-md-6 pad_left_0">
	         					<p><?php echo _l('invoice_amount').':'; ?><span class="pull-right bold"><?php echo app_format_money($pur_invoice->total,$base_currency->name); ?></span></p>
	         				</div>
	         			...
	         			<?php if($pur_invoice->currency_rate != 1){ ?>
                        <div class="col-md-12 mtop15 pad_right_0">
                        <span class="label label-default pull-right btn"><?php echo _l('currency_rate').': '; ?><?php echo pur_html_entity_decode($pur_invoice->currency_rate); ?></span>
                        </div>
                       <?php } ?>
	         			<div class="col-md-12 pad_left_0 pad_right_0">
	                           ...
	                           <tbody>
	                              <tr id="inv_subtotal">
	                                 ...
	                                 <td class="inv_subtotal">
	                                    <?php echo app_format_money($pur_invoice->subtotal,$base_currency->name); ?>
	                                 </td>
	                              </tr>
	                              ...
	                              <tr id="inv_discount_total">
	                                 ...
	                                 <td class="inv_discount_total">
	                                    <?php echo '-'.app_format_money(($pur_invoice->discount_total + $item_discount), $base_currency->name); ?>
	                                 </td>
	                              </tr>
	                              <?php } ?>
	                              ...
	                              <tr id="inv_discount_total">
	                                 ...
	                                 <td class="inv_discount_total">
	                                    <?php echo app_format_money($pur_invoice->shipping_fee, $base_currency->name); ?>
	                                 </td>
	                              </tr>
	                              <?php } ?>
	                              ...
	                              <tr id="inv_total">
	                                 ...
	                                 <td class="inv_total bold">
	                                    <?php echo app_format_money($pur_invoice->total, $base_currency->name); ?>
	                                 </td>
	                              </tr>
	                           </tbody>
	                        </table>
                           ...
                           <div class="col-md-12 project-overview-expenses-finance">
                            ...
                            foreach ($list_approve_status as $value) {
                             ...
                             <div class="col-md-4 apr_div">
                                 ...
                                 <?php if($value['approve'] == 2){ 
                                  ...
                                  <?php if(file_exists(PURCHASE_MODULE_UPLOAD_FOLDER.'/pur_invoice/signature/'.$pur_invoice->id.'/signature_'.$value['id'].'.png')){ ?>
                                    <img src="<?php echo site_url(PURCHASE_PATH.'pur_invoice/signature/'.$pur_invoice->id.'/signature_'.$value['id'].'.png'); ?>" class="img_style">
                                    <?php }else if(file_exists(PURCHASE_MODULE_UPLOAD_FOLDER.'/pur_invoice/signature/'.$pur_invoice->id.'/signature_'.$value['id'].'.jpg')){ ?>
                                       <img src="<?php echo site_url(PURCHASE_PATH.'pur_invoice/signature/'.$pur_invoice->id.'/signature_'.$value['id'].'.jpg'); ?>" class="img_style">
                                    <?php } ?>
                            ...
                            <div class="col-md-4 apr_div" >
                                 ...
                                 <?php if($value['approve'] == 2){ 
                                  ...
                                  <?php if(file_exists(PURCHASE_MODULE_UPLOAD_FOLDER.'/pur_invoice/signature/'.$pur_invoice->id.'/signature_'.$value['id'].'.png')){ ?>
	                                <br><img src="<?php echo site_url(PURCHASE_PATH.'pur_invoice/signature/'.$pur_invoice->id.'/signature_'.$value['id'].'.png'); ?>" class="img_style">
	                                <?php }else if(file_exists(PURCHASE_MODULE_UPLOAD_FOLDER.'/pur_invoice/signature/'.$pur_invoice->id.'/signature_'.$value['id'].'.jpg')){ ?>
	                                   <br><img src="<?php echo site_url(PURCHASE_PATH.'pur_invoice/signature/'.$pur_invoice->id.'/signature_'.$value['id'].'.jpg'); ?>" class="img_style">
	                                <?php } ?>
                        ...
                        <div class="<?php if(!is_mobile()){ echo 'pull-left'; } ?> mleft5 mright5">
                          <?php if($check_appr && $check_appr != false){
                          	if(($pur_invoice->approval_status == 1 && ($check_approve_status == false || $check_approve_status == 'reject')) || ($pur_invoice->approval_status == 1 && $appr_setting->approval_type == 1 && is_array($check_approve_status['staffid']) && count($check_approve_status['staffid']) != count($list_approve_status)) ){ ?>
                      <a data-toggle="tooltip" data-loading-text="<?php echo _l('wait_text'); ?>" class="btn btn-success lead-top-btn lead-view" data-placement="top" href="#" onclick="send_request_approve(<?php echo pur_html_entity_decode($pur_invoice->id); ?>); return false;"><?php echo _l('send_request_approve_pur'); ?></a>
                    <?php } }
                      if(isset($check_approve_status['staffid'])){
                          ?>
                          <?php 
                      if(in_array(get_staff_user_id(), $check_approve_status['staffid']) && !in_array(get_staff_user_id(), $get_staff_sign) && $pur_invoice->approval_status == 1){ ?>
                          <div class="btn-group" >
                                 ...
                                 <ul class="dropdown-menu dropdown-menu-<?php if(is_mobile()){ echo 'left';}else{ echo 'left';} ?> ul_style" >
                                  <li>
                                    <div class="col-md-12">
                                      <?php echo render_textarea('reason', 'pur_reason'); ?>
                                    </div>
                                    ...
                                    <?php if(get_option('allow_upload_esign_for_approve_type') == 1){ ?>
                                       <div class="col-md-12 mbot15">
                                          <?php echo form_open_multipart(admin_url('purchase/sign_attachment'),array('id'=>'sign_attachment-form')); ?>
                                             ...
                                             <?php echo form_hidden('approve_rel_id', $pur_invoice->id) ?>
                                             <?php echo form_hidden('approve_rel_type', 'purchase_invoice') ?>
                                    ...
                                    <li>
                                      <div class="row text-right col-md-12 pad_right_0 mbot15">
                                        <a href="#" data-loading-text="<?php echo _l('wait_text'); ?>" onclick="approve_request(<?php echo pur_html_entity_decode($pur_invoice->id); ?>); return false;" class="btn btn-success mright15" ><?php echo _l('approve'); ?></a>
                                       <a href="#" data-loading-text="<?php echo _l('wait_text'); ?>" onclick="deny_request(<?php echo pur_html_entity_decode($pur_invoice->id); ?>); return false;" class="btn btn-warning"><?php echo _l('deny'); ?></a></div>
                                    </li>
                                 </ul>
                              </div>
                        <?php }
		               ...
		               <table class="table dt-table">
		                  ...
		                  <tbody>
		                     <?php foreach($payment as $pay) { ?>
		                        <tr>
		                           <td><?php echo app_format_money($pay['amount'],$base_currency->name); ?></td>
		                  ...
		                  <table class="table table-bordered table-hover no-mtop">
		                     ...
		                     <tbody>
		                        ...
		                        <tr>
		                           ...
		                           <td><?php echo app_format_money($debit['amount'], $base_currency->name) ?>
        ...
        <div class="modal-body">
         ...
         <div class="form-group">
          ...
          <div class="modal-footer">
           ...
           <button id="sign_button" onclick="sign_request(<?php echo pur_html_entity_decode($pur_invoice->id); ?>);" data-loading-text="<?php echo _l('wait_text'); ?>" autocomplete="off" class="btn btn-success"><?php echo _l('e_signature_sign'); ?></button>
          </div>
...
<?php require 'modules/purchase/assets/js/invoices/pur_invoice_preview_js.php';?>
</body>
</html>