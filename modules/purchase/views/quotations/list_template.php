...
<div class="col-md-12">
  <div class="panel_s mbot10">
   ...
   <div class="row mtop15">
     <div class="col-md-3">
        <label for="pur_request"><?php echo _l('purchase_request'); ?></label>
    ...
    <label for="vendor"><?php echo _l('vendor'); ?></label>
        <select name="vendor[]" id="vendor" class="ajax-sesarch" multiple="true"  data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('vendor'); ?>" >
