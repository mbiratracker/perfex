         ...
         <div class="row">
            ...
            <div class="col-md-8">
              ...
              <?php if($estimate->status != 2){ ?>
                  ...
                  <?php if(has_permission('purchase_quotations','','edit') && count($list_approve_status) == 0 ){ ?>
              ...
              <?php if(has_permission('purchase_estimate_change_approve_status', '', 'edit')){ ?>
               ...
               <div class="pull-right mright5">
                            ...
                            if(($estimate->status == 1 && ($check_approve_status == false || $check_approve_status == 'reject')) || ($estimate->status == 1 && $appr_setting->approval_type == 1 && is_array($check_approve_status['staffid']) && count($check_approve_status['staffid']) != count($list_approve_status)) ){ ?>
                                      ...
                                      <div class="col-md-12">
                                       ...
                                       <div class="col-md-12 mbot15">
                                          <?php echo form_open_multipart(admin_url('purchase/sign_attachment'),array('id'=>'sign_attachment-form')); ?>
                                             ...
                                             <?php echo form_hidden('approve_rel_type', 'pur_quotation') ?>
                           ...
                           <div class="col-md-12 project-overview-expenses-finance">
                            ...
                            foreach ($list_approve_status as $value) {
                             ...
                             <div class="col-md-4 apr_div">
                                 ...
                                 <?php if($value['approve'] == 2){ 
                                  ...
                                  <?php if(file_exists(PURCHASE_MODULE_UPLOAD_FOLDER.'/pur_estimate/signature/'.$estimate->id.'/signature_'.$value['id'].'.png')){ ?>
                                    <img src="<?php echo site_url(PURCHASE_PATH.'pur_estimate/signature/'.$estimate->id.'/signature_'.$value['id'].'.png'); ?>" class="img_style">
                                    <?php }else if(file_exists(PURCHASE_MODULE_UPLOAD_FOLDER.'/pur_estimate/signature/'.$estimate->id.'/signature_'.$value['id'].'.jpg')){ ?>
                                       <img src="<?php echo site_url(PURCHASE_PATH.'pur_estimate/signature/'.$estimate->id.'/signature_'.$value['id'].'.jpg'); ?>" class="img_style">
                                    <?php } ?>
                            ...
                            <div class="col-md-4 apr_div" >
                                 ...
                                 <?php if($value['approve'] == 2){ 
                                  ...
                                  <?php if(file_exists(PURCHASE_MODULE_UPLOAD_FOLDER.'/pur_estimate/signature/'.$estimate->id.'/signature_'.$value['id'].'.png')){ ?>
                                    <br><img src="<?php echo site_url(PURCHASE_PATH.'pur_estimate/signature/'.$estimate->id.'/signature_'.$value['id'].'.png'); ?>" class="img_style">
                                    <?php }else if(file_exists(PURCHASE_MODULE_UPLOAD_FOLDER.'/pur_estimate/signature/'.$estimate->id.'/signature_'.$value['id'].'.jpg')){ ?>
                                      <br> <img src="<?php echo site_url(PURCHASE_PATH.'pur_estimate/signature/'.$estimate->id.'/signature_'.$value['id'].'.jpg'); ?>" class="img_style">
                                    <?php } ?>
