            ...
            <div class="panel_s">
               <div class="panel-body">
	                     ...
	                     <div class="col-md-4 border-right">
		                  ...
		                  <div class="col-md-4 border-right">
		                    ...
		                    <p><a href="#" class="font-medium" onclick="init_report(this,'statistics_cost_of_purchase_orders'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('purchase_statistics_by_cost'); ?></a></p>
		                     <hr class="hr-10" />
		                    <p><a href="#" class="font-medium" onclick="init_report(this,'statistics_payable_receivable'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('statistics_payable_receivable'); ?></a></p>

		                     <hr class="hr-10" />
		                    <p><a href="#" class="font-medium" onclick="init_report(this,'statistics_po_by_type'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('statistics_po_by_type'); ?></a></p>
		                 </div>
		                 <div class="col-md-4">
			        ...
			        <div id="report" class="hide">
			          	...
			          	<div class="col-md-12">
		               		<?php $this->load->view('payable_receivable_rp'); ?>
			          	</div>

			          	<div class="col-md-12">
		               		<?php $this->load->view('statistics_po_by_type'); ?>
			          	</div>
		            </div>
	            </div>      
              </div>
