...
define('HR_PROFILE_TRAINING_ATTACHMENTS_UPLOAD_FOLDER', module_dir_path(HR_PROFILE_MODULE_NAME, 'uploads/training_programs/'));
...
define('VERSION_HR_PROFILE', 1116);
...
function hr_profile_load_js(){    
	...
	function hr_profile_permissions()
	{
		...
		//Training
		register_staff_capabilities('staffmanage_training', $capabilities_2, _l('HR_training'));
		//Q&A
