						...
						<div class="row">
							...
							<div class="col-md-3 pull-left">
								<?php if(is_admin() || has_permission('hrm_reception_staff','','create')){ ?>
									<button type="button" class="btn btn-primary" onclick="new_reception();"><?php echo _l('hr_add_reception'); ?></button>
								<?php } ?>
					...
					<div class="col-md-12">
						...
						<select name="staff_id" data-live-search="true" class="selectpicker" id="staff_id" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>" required> 
							...
							<?php foreach ($list_staff_not_record as $e){ ?>
								<option value="<?php echo new_html_entity_decode($e['staffid']) ?>"><?php echo new_html_entity_decode($e['firstname'].' '.$e['lastname']); ?></option>
							<?php } ?>
						</select>
					</div>
