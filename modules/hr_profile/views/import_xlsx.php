...
<?php 
		...
		$file_header[] = _l('hr_hr_home_town'); 
			...
			<div class="col-md-12">
				<div class="panel_s">
					<div class="panel-body">
						...
						<input type="hidden" name="language" value="<?php echo new_html_entity_decode($active_language); ?>">
						<?php
						if(!isset($simulate)) { ?>
							<ul>
										...
										<tbody>
											...
											if(count($departments) > 0 ){
												foreach($departments as $value){ 
													...
													?> 
													<tr>
														<td><?php echo new_html_entity_decode($value['departmentid']); ?></td>
											...
											<tbody>
												...
												if(count($job_positions) > 0) {
													foreach($job_positions as $value){ 
														?> 
														<tr>
															<td><?php echo new_html_entity_decode($value['position_id']); ?></td>
															<td><?php echo new_html_entity_decode($value['position_name']); ?></td>
														</tr>
													<?php } }?>
												</tbody>
											</table>
													...
													if(count($workplaces) > 0 ){
														foreach($workplaces as $value){ 
															...
															<tr>
																...
																<td><?php echo new_html_entity_decode($value['name']); ?></td>
																<td><?php echo new_html_entity_decode($value['workplace_address']); ?></td>
															</tr>
														<?php } } ?>
													</tbody>
												</table>
									...
									<div class="row">
										<div class="col-md-4">
											...
											<div class="form-group">
												<button id="uploadfile" type="button" class="btn btn-primary import" onclick="return uploadfilecsv();" ><?php echo _l('import'); ?></button>
											</div>
											<?php echo form_close(); ?>
										</div>
										<div class="col-md-8">
