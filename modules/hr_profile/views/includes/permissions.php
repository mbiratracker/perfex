			...
			<div class="modal-body">
				...
				<div class="table-responsive">
					...
					<table class="table table-bordered roles no-margin">
						<thead>
							<tr>
								<th><?php echo _l('feature'); ?></th>
								<th><?php echo _l('capabilities'); ?></th>
							</tr>
						</thead>
						<tbody>
							<?php
							...
							foreach(get_available_staff_permissions($funcData) as $feature => $permission) { ?>
								<tr data-name="<?php echo new_html_entity_decode($feature); ?>" class="<?php if(!in_array($feature, $hr_profile_permissions)){echo "hide";} ?>">
									<td>
