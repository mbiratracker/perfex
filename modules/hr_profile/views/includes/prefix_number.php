...
<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="row">
			<div class="col-md-12">
				<h5 class="no-margin font-bold h5-color"><?php echo _l('hr_staff_profile') ?></h5>
				<hr class="hr-color">
			</div>
		</div>
		<div class="row">
			<div class="col-md-12">
				<div class="form-group">
					<div class="checkbox checkbox-primary">
						<input type="checkbox" id="hide_general_staff_information" name="hide_general_staff_information" <?php if(get_option('hide_general_staff_information') == 1 ){ echo 'checked';} ?> value="1">
						<label for="hide_general_staff_information"><?php echo _l('hr_hide_general_staff_information'); ?></label>
						<i class="fa fa-question-circle i_tooltip" data-toggle="tooltip" title="" data-original-title="<?php echo _l('hr_hide_general_staff_information_tooltip'); ?>"></i>
					</div>
				</div>
			</div>
		</div>
