...
<div>
	...
	<table class="table dt-table">
		<thead>
			...
			<th class="hide"><?php echo _l('hr_taxable'); ?></th>
				...
				<tr>
					...
					<td>
						...
						<?php if(has_permission('hrm_setting', '', 'edit') || is_admin() ){ ?>
							<a href="#" onclick="edit_salary_form(this,<?php echo new_html_entity_decode($c['form_id']); ?>); return false" data-taxable="<?php echo new_html_entity_decode($c['tax']); ?>" data-name="<?php echo new_html_entity_decode($c['form_name']); ?>" data-amount="<?php echo new_html_entity_decode($c['salary_val']); ?>" class="btn btn-default btn-icon"><i class="fa-regular fa-pen-to-square"></i></a>
						<?php } ?>
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="form">     
								...
								echo render_input('salary_val','hr_amount_of_money','','number',$arrAtt); ?> 

								<div class="form-group hide">
									<label for="tax" class="control-label"><?php echo _l('hr_taxable'); ?></label>
