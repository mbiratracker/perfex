					...
					<div class="row title">                           
						<div class="col-md-11 pt-2">
							<div class="form-group">
								<input type="text" name="title_name[<?php echo new_html_entity_decode($key); ?>]" class="form-control" placeholder="<?php echo _l('hr_title'); ?>" value="<?php echo new_html_entity_decode($value['group_name']); ?>">
							</div>
						</div>
							...
							<div class="col-md-12 pl-0">
								<div class="sub">                           
									<div class="col-md-10 pt-2">
										<div class="form-group">
											<input type="text" name="sub_title_name[<?php echo new_html_entity_decode($key); ?>][<?php echo new_html_entity_decode($ind); ?>]" data-count="<?php echo new_html_entity_decode($key); ?>" class="form-control" value="<?php echo new_html_entity_decode($sub_item['name']); ?>" placeholder="<?php echo _l('hr_sub_title'); ?>">
										</div>
									</div>
						...
						<div id ="assets_emp" class="row">                            
							<div class="col-md-11 pt-2">
								<div class="form-group">
									...
									?>
									<input type="text" name="asset_name[]" class="form-control" value="<?php echo new_html_entity_decode($name); ?>" placeholder="<?php echo _l('hr_enter_property_name'); ?>" >
								</div>
							</div>                            
							<div class="col-md-1 pl-0 pt-0" name="button_add">
						...
						<div class="form-group mt-2">
							<select name="training_type" class="selectpicker" id="training_type" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>"> 
								...
								<?php foreach ($type_of_trainings as $key => $value) { ?>
									...
									<option value="<?php echo new_html_entity_decode($value['id']); ?>" <?php if(isset($setting_training) && $setting_training->training_type == $value['id'] ){echo 'selected';}; ?> ><?php echo new_html_entity_decode($value['name']); ?></option>
