				...
				<div class="panel_s">
					...
					<div class="panel-body">
						...
						<div class="mtop15 preview-top-wrapper">
							...
							<div class="row">
								<div class="col-md-12">
									<h4 class="pull-left no-mtop contract-html-subject"><?php echo new_html_entity_decode($contract->contract_code); ?><br />
									...
									<?php if($contract->signature == '' ) { ?>
										<?php if(is_admin() || get_staff_user_id() == $contract->staff_delegate){ ?>
											<button type="submit" id="accept_action" class="btn btn-success pull-right action-button mright5"><?php echo _l('e_signature_sign'); ?></button>
										<?php } ?>
												...
												<div role="tabpanel" class="tab-pane<?php if(!$this->input->get('tab') || $this->input->get('tab') === 'summary'){echo ' active';} ?>" id="summary">
													...
													<div class="row mtop20">
														...
														<div class="col-md-7 contract-number">
															<?php echo new_html_entity_decode($contract->contract_code); ?>
														</div>
														...
														<?php if(!empty($contract->type_name)){ ?>
															...
															<div class="col-md-7 contract-type">
																<?php echo new_html_entity_decode($contract->name_contract); ?>
															</div>
														<?php } ?>
														<?php if($contract->signature != ''){ ?>
															<div class="col-md-5 text-muted contract-type">
													...
													<?php if($contract->staff_signature != ''){ ?>
														<div class="row mtop20">
															...
															<div class="col-md-7 contract-contract-signed-by">
																<?php echo new_html_entity_decode($contracts_staff_signer); ?>
															</div>
														...
														<div class="row mtop20">
															<?php if ( new_strlen($contract->staff_signature) > 0) { ?>
													...
													<?php if($contract->signature != ''){ ?>
														<div class="row mtop20">
															...
															<div class="col-md-7 contract-contract-signed-by">
																<?php echo new_html_entity_decode($contracts_signer); ?>
															</div>
														...
														<div class="row mtop20">
															<?php if ( new_strlen($contract->signature) > 0) { ?>
