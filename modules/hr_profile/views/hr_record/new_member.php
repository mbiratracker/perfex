							...
							<div class="tab-content">
								<div role="tabpanel" class="tab-pane active" id="tab_staff_profile">
									...
									<div class="row">
										...
										<div class="col-md-12">
											...
											<div class="form-group" app-field-wrapper="staff_identifi">
												...
												<input type="text" id="staff_identifi" name="staff_identifi" class="form-control" value="<?php echo new_html_entity_decode($hr_codes) ?>" aria-invalid="false" <?php if(!is_admin() && !has_permission('hrm_hr_records','', 'edit') && !has_permission('hrm_hr_records','', 'create')){ echo 'disabled' ; }  ?>>
											</div>
										</div> 
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<select name="sex" class="selectpicker" id="sex" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>"> 
													<option value=""></option>                  
													<option value="<?php echo 'male'; ?>" <?php if(isset($member) && $member->sex == 'male'){echo 'selected';} ?>><?php echo _l('hr_male'); ?></option>
													<option value="<?php echo 'female'; ?>" <?php if(isset($member) && $member->sex == 'female'){echo 'selected';} ?>><?php echo _l('hr_female'); ?></option>
												</select>
											</div>
										</div>
									...
									<div class="row">
										<div class="col-md-6">
											...
											<div class="form-group" app-field-wrapper="email">
												...
												<input type="email" id="email" name="email" class="form-control" autocomplete="off" value="<?php echo new_html_entity_decode($value) ?>" <?php if(!is_admin() && !has_permission('hrm_hr_records','', 'edit') && !has_permission('hrm_hr_records','', 'create')){ echo 'disabled' ;}  ?>>
											</div>
										</div>
											...
											<div class="form-group">
												...
												<select name="workplace" class="selectpicker" id="workplace" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>"> 
													...
													<?php foreach($workplace as $w){ ?>
														...
														<option value="<?php echo new_html_entity_decode($w['id']); ?>" <?php if(isset($member) && $member->workplace == $w['id']){echo 'selected';} ?>><?php echo new_html_entity_decode($w['name']); ?></option>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="input-group">
													<input type="number" name="hourly_rate" value="<?php if(isset($member)){echo new_html_entity_decode($member->hourly_rate);} else {echo 0;} ?>" id="hourly_rate" class="form-control">
									...
									<div role="tabpanel" class="tab-pane " id="tab_staff_contact">
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<select name="marital_status" class="selectpicker" id="marital_status" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>"> 
														...
														<option value="<?php echo 'married'; ?>" <?php if(isset($member) && $member->marital_status == 'married'){echo 'selected';} ?>><?php echo _l('hr_married'); ?></option>
													</select>
												</div>
											</div>
										...
										<?php 
										$passport_no = (isset($member) ? $member->passport_no : '');
										$passport_expiry = (isset($member) ? _d($member->passport_expiry) : '');
										$emirates_ID_No = (isset($member) ? $member->emirates_ID_No : '');
										$EID_expiry = (isset($member) ? _d($member->EID_expiry) : '');
										$labour_card_No = (isset($member) ? $member->labour_card_No : '');
										$contact_person_home_country = (isset($member) ? $member->contact_person_home_country : '');
										$home_contact_No = (isset($member) ? $member->home_contact_No : '');
										$other_contact_person = (isset($member) ? $member->other_contact_person : '');
										$other_contact_No = (isset($member) ? $member->other_contact_No : '');
										$visa_validity = (isset($member) ? _d($member->visa_validity) : '');
										?>
										<div class="row">
											<div class="col-md-6">
												<?php
												echo render_input('passport_no','hr_passport_no',$passport_no, 'text'); ?>
											</div>
											<div class="col-md-6">
												<?php
												echo render_date_input('passport_expiry','hr_passport_expiry',_d($passport_expiry));
												?>
											</div>
										</div>
										<div class="row">
											<div class="col-md-6">
												<?php
												echo render_input('emirates_ID_No','hr_emirates_ID_No',$emirates_ID_No, 'text'); ?>
											</div>
											<div class="col-md-6">
												<?php
												echo render_date_input('EID_expiry','hr_EID_expiry',_d($EID_expiry));
												?>
											</div>
										</div>
										<div class="row">
											<div class="col-md-6">
												<?php
												echo render_input('contact_person_home_country','hr_contact_person_home_country',$contact_person_home_country, 'text'); ?>
											</div>
											<div class="col-md-6">
												<?php
												echo render_input('home_contact_No','hr_home_contact_No',$home_contact_No, 'text'); ?>
											</div>
										</div>
										<div class="row">
											<div class="col-md-6">
												<?php
												echo render_input('other_contact_person','hr_other_contact_person',$other_contact_person, 'text'); ?>
											</div>
											<div class="col-md-6">
												<?php
												echo render_input('other_contact_No','hr_other_contact_No',$other_contact_No, 'text'); ?>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-6">
												<?php
												echo render_input('labour_card_No','hr_labour_card_No',$labour_card_No, 'text'); ?>
											</div>
											<div class="col-md-6">
												<?php
												echo render_date_input('visa_validity','hr_visa_validity', $visa_validity);
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="skype" value="<?php if(isset($member)){echo new_html_entity_decode($member->skype);} ?>">
												</div>
											</div>
