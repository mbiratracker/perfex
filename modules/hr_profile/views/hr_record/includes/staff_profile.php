						...
						<div class="card-body">
							<div class="text-center">
								<div class="userprofile">
									...
									<h3 class="username mb-2"><?php echo new_html_entity_decode($member->firstname . ' ' . $member->lastname); ?></h3>
									<div class="socials text-center mt-3">
										<a href="<?php echo html_escape($member->facebook); ?>" target="_blank" class="btn btn-circle">
											<i class="fa-brands fa-facebook"></i>
										</a>
										<a href="<?php echo html_escape($member->linkedin); ?>" target="_blank" class="btn btn-circle">
											<i class="fa-brands fa-linkedin"></i>
										</a>
										<a href="<?php echo html_escape($member->skype); ?>" target="_blank" class="btn btn-circle">
			...
			<div class="card panel-theme">
				<div class="card-body no-padding">
					<ul class="list-group no-margin">
						...
						<li class="list-group-item"><i class="fa fa-graduation-cap mr-4"></i> <?php echo !is_null($member->literacy) && $member->literacy != '' ? _l('hr_'.$member->literacy ) : '' ?></li>
...
<?php if(($member->staffid == get_staff_user_id() && get_option('hide_general_staff_information') == 0 ) || is_admin() || has_permission('hrm_hr_records', '', 'edit') || has_permission('hrm_hr_records', '', 'create')){ ?>
			<div class="col-md-12">
				...
				<table class="table border table-striped ">
					<tbody>
						<tr class="project-overview">
							...
							<td><?php echo new_html_entity_decode($member->staff_identifi); ?></td>
						</tr>
						<tr class="project-overview">
							<td class="bold" width="30%"><?php echo _l('hr_hr_staff_name'); ?></td>
							<td><?php echo new_html_entity_decode($member->firstname . ' ' . $member->lastname); ?></td>
						</tr>
						<tr class="project-overview">
						...
						<tr class="project-overview">
							...
							<td>
								<?php echo new_html_entity_decode(hr_profile_get_workplace_name($member->workplace ?? '')) ?>
							</td>
						</tr>
						<tr class="project-overview">
							<td class="bold" width="40%"><?php echo _l('hr_status_label'); ?></td>
							<td>
								<?php echo new_html_entity_decode(_l($member->status_work ?? '')) ?>
							</td>
						</tr>
						<tr class="project-overview">
...
if ($member->job_position > 0) {
	...
	?>
	<a href="<?php echo admin_url() . 'hr_profile/job_position_view_edit/' . $member->job_position; ?>"><?php echo new_html_entity_decode($job_position_name); ?></a>
										<?php
}
...
?>
						...
						<tr class="project-overview">
							...
							<td>
								<?php echo new_html_entity_decode(_l($member->literacy ?? '')) ?>
							</td>
						</tr>
						<tr class="project-overview">
							<td class="bold" width="40%"><?php echo _l('staff_hourly_rate'); ?></td>
							<td>
								<?php echo new_html_entity_decode($member->hourly_rate) ?>
							</td>
						</tr>

						<tr class="project-overview">
							<td class="bold"><?php echo _l('hr_hr_religion'); ?></td>
							<td><?php echo new_html_entity_decode($member->religion); ?></td>
						</tr>
						<tr class="project-overview">
							<td class="bold"><?php echo _l('hr_hr_nation'); ?></td>
							<td><?php echo new_html_entity_decode($member->nation); ?></td>
						</tr>
...
<?php } ?>
				...
				<table class="table border table-striped ">
					<tbody>
						...
						<tr class="project-overview">
							...
							<td><?php echo new_html_entity_decode($member->current_address); ?></td>
						</tr>
						<tr class="project-overview">
							<td class="bold"><?php echo _l('hr_hr_resident'); ?></td>
							<td><?php echo new_html_entity_decode($member->resident); ?></td>
						</tr>
						<tr class="project-overview">
						...
						<tr class="project-overview">
							...
							<td><?php echo new_html_entity_decode($member->name_account); ?></td>
						</tr>
						<tr class="project-overview">
						...
						<tr class="project-overview">
							<td class="bold"><?php echo _l('hr_passport_no'); ?></td>
							<td><?php echo new_html_entity_decode($member->passport_no); ?></td>
						</tr>
						<tr class="project-overview">
							<td class="bold"><?php echo _l('hr_passport_expiry'); ?></td>
							<td><?php echo new_html_entity_decode($member->passport_expiry); ?></td>
						</tr>
						<tr class="project-overview">
							<td class="bold"><?php echo _l('hr_emirates_ID_No'); ?></td>
							<td><?php echo new_html_entity_decode($member->emirates_ID_No); ?></td>
						</tr>
						<tr class="project-overview">
							<td class="bold"><?php echo _l('hr_EID_expiry'); ?></td>
							<td><?php echo new_html_entity_decode($member->EID_expiry); ?></td>
						</tr>
						<tr class="project-overview">
							<td class="bold"><?php echo _l('hr_labour_card_No'); ?></td>
							<td><?php echo new_html_entity_decode($member->labour_card_No); ?></td>
						</tr>
						<tr class="project-overview">
							<td class="bold"><?php echo _l('hr_contact_person_home_country'); ?></td>
							<td><?php echo new_html_entity_decode($member->contact_person_home_country); ?></td>
						</tr>
						<tr class="project-overview">
							<td class="bold"><?php echo _l('hr_home_contact_No'); ?></td>
							<td><?php echo new_html_entity_decode($member->home_contact_No); ?></td>
						</tr>
						<tr class="project-overview">
							<td class="bold"><?php echo _l('hr_other_contact_person'); ?></td>
							<td><?php echo new_html_entity_decode($member->other_contact_person); ?></td>
						</tr>
						<tr class="project-overview">
							<td class="bold"><?php echo _l('hr_other_contact_No'); ?></td>
							<td><?php echo new_html_entity_decode($member->other_contact_No); ?></td>
						</tr>
						<tr class="project-overview">
							<td class="bold"><?php echo _l('hr_visa_validity'); ?></td>
							<td><?php echo new_html_entity_decode($member->visa_validity); ?></td>
						</tr>
			...
			<div class="col-md-12">
				...
				<h5 class="text-justify"><?php echo new_html_entity_decode($member->orther_infor); ?></h5>
			</div>
		<?php } ?>
