			...
			<div class="col-md-3">
				<ul class="nav navbar-pills navbar-pills-flat nav-tabs nav-stacked">
					...
					foreach($tab as $gr){
						...
						<a href="<?php echo admin_url('manufacturing/setting?group='.$gr); ?>" data-group="<?php echo new_html_entity_decode($gr); ?>">
							<?php
								...
								$icon['approval_setting'] = '<span class="fa-solid fa-person-circle-check"></span>';
...
}elseif(!(strpos($viewuri,'admin/manufacturing/setting?group=approval_setting') === false)){
	require 'modules/manufacturing/assets/js/settings/approval_setting_js.php';
}
