...
<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="row">
			<div class="col-md-12">
				<h5 class="no-margin font-bold h5-color"><?php echo _l('working_hour') ?></h5>
				<hr class="hr-color">
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-12">
				<h5 class="no-margin  font-bold h5-color"><?php echo _l('mo_lot_number_from_mo_number') ?></h5>
				<hr class="hr-color">
			</div>
		</div>
		...
		<div class="form-group">
			<div class="checkbox checkbox-primary">
				<input type="checkbox" id="lot_number_from_mo_number" name="lot_number_from_mo_number" <?php if(get_mrp_option('lot_number_from_mo_number') == 1 ){ echo 'checked';} ?> value="1">
				<label for="lot_number_from_mo_number"><?php echo _l('mo_create_lot_number_from_MO_number'); ?>
			</label>
		</div>
	</div>
