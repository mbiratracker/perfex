			...
			<div class="col-md-12" >
				<div class="panel_s">
					...
					<div class="panel-body">
						...
						<div class="row">
						<?php if($manufacturing_order->approval == 1){ ?>
							<div class="col-md-12">
						...
						<div class="modal-body">
							...
							<div class="">
												...
												foreach ($list_approve_status as $value) {
													...
													if($value['action'] == 'sign'){
														...
														<div class="col-md-3 text-center">
															...
															<?php if($value['approve'] == 1){ 
																?>
																<?php if (file_exists(MANUFACTURING_ORDER_UPLOAD_FOLDER . $manufacturing_order->id . '/signature_'.$value['id'].'.png') ){ ?>

																	<img src="<?php echo site_url('modules/manufacturing/uploads/manufacturing_orders/'.$manufacturing_order->id.'/signature_'.$value['id'].'.png'); ?>" class="img-width-height">

																<?php }else{ ?>
																	<img src="<?php echo site_url('modules/manufacturing/uploads/image_not_available.jpg'); ?>" class="img-width-height">
																<?php } ?>
													...
													<?php }else{ ?>
														<div class="col-md-3 text-center">
															...
															<?php if($value['approve'] == 1){ 
																?>
																<img src="<?php echo site_url('modules/manufacturing/uploads/approval/approved.png') ; ?>" class="img-width-height">
															<?php }elseif($value['approve'] == -1){ ?>
																<img src="<?php echo site_url('modules/manufacturing/uploads/approval/rejected.png') ; ?>" class="img-width-height">
															<?php }
															?>
								...
								<div class="pull-left">
									...
									<?php 
									if($manufacturing_order->approval != 1 && ($check_approve_status == false ))

										{ ?>
											<?php if($check_appr && $check_appr != false){ ?>

												<a data-toggle="tooltip" data-loading-text="<?php echo _l('wait_text'); ?>" class="btn btn-success lead-top-btn lead-view" data-placement="top" href="#" onclick="send_request_approve(<?php echo new_html_entity_decode($manufacturing_order->id); ?>); return false;"><?php echo _l('send_request_approve'); ?></a>
											<?php } ?>
										...
										if(isset($check_approve_status['staffid'])){
											?>
											<?php 
											if(in_array(get_staff_user_id(), $check_approve_status['staffid']) && !in_array(get_staff_user_id(), $get_staff_sign)  && $manufacturing_order->approval == 0){ ?>
												<div class="btn-group" >
													...
													<ul class="dropdown-menu dropdown-menu-right menu-width-height">
														...
														<li>
															<div class="row text-right col-md-12">
																<a href="#" data-loading-text="<?php echo _l('wait_text'); ?>" onclick="approve_request(<?php echo new_html_entity_decode($manufacturing_order->id); ?>); return false;" class="btn btn-success button-margin"><?php echo _l('approve'); ?></a>
																<a href="#" data-loading-text="<?php echo _l('wait_text'); ?>" onclick="deny_request(<?php echo new_html_entity_decode($manufacturing_order->id); ?>); return false;" class="btn btn-warning"><?php echo _l('deny'); ?></a></div>
															</li>
														</ul>
													</div>
												<?php }
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="row">
							...
							<div class="col-md-12">
								<label class="text-danger "><?php echo _l('If_the_actual_quantity_of_products_produced_note'); ?></label>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<button onclick="sign_request(<?php echo new_html_entity_decode($manufacturing_order->id); ?>);"  autocomplete="off" class="btn btn-success sign_request_class"><?php echo _l('e_signature_sign'); ?></button>
					</div>
				</div>
			</div>
		</div>
