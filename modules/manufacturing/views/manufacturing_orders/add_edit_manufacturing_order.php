...
<div id="wrapper">
	<div class="content">
		<div class="row">
			...
			<?php }else{ ?>
				<?php echo form_open_multipart(admin_url('manufacturing/add_edit_manufacturing_order'), array('id' => 'add_update_manufacturing_order','autocomplete'=>'off')); ?>
			<?php } ?>
						...
						<div class="modal-body">
							<div class="tab-content">
								...
								<div class="row">
									...
									<div class="row">
										<div class="col-md-6">
											<?php if(mrp_get_status_modules('product_lifecycle') == 1){ ?>
												<?php echo render_select('bom_id',$bill_of_materials,array('id', 'description','version'), 'bill_of_material_label', $bom_id, $disabled_edit, [], '', '' , false); ?>
											<?php }else{ ?>
							...
							<div class="modal-footer">
								...
								<?php if((has_permission('manufacturing', '', 'create') || has_permission('manufacturing', '', 'edit')) && ( !isset($manufacturing_order) || (isset($manufacturing_order) && ($manufacturing_order->status == 'draft' || $manufacturing_order->status == 'done') ))){ ?>
