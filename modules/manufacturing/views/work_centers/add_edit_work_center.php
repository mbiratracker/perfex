...
<div id="wrapper">
	<div class="content">
		<div class="row">
			...
			<?php }else{ ?>
				<?php echo form_open_multipart(admin_url('manufacturing/add_edit_work_center'), array('id' => 'add_update_work_center','autocomplete'=>'off')); ?>
			<?php } ?>
					...
					<div class="panel-body">
						<div class="row mb-5">
							...
							<div class="col-md-7">
								...
								</div>%</span><span class="o_stat_text"><?php echo _l('mrp_OEE'); ?></span></div></button><button type="button" name="241" class="btn oe_stat_button"><i class="fa fa-fw o_button_icon fa-bar-chart"></i><div class="o_field_widget o_stat_info"><span class="o_stat_value"><div name="blocked_time" class="o_field_widget o_stat_info o_readonly_modifier" data-original-title="" title="">
									<span class="o_stat_value">0.00</span>
									<span class="o_stat_text"></span>
								</div> <?php echo _l('mrp_Hours'); ?></span><span class="o_stat_text"><?php echo _l('mrp_Lost'); ?></span></div></button><button type="button" name="237" class="btn oe_stat_button" context="{'search_default_workcenter_id': id}"><i class="fa fa-fw o_button_icon fa-bar-chart"></i><div class="o_field_widget o_stat_info"><span class="o_stat_value"><div name="workcenter_load" class="o_field_widget o_stat_info o_readonly_modifier">
									<span class="o_stat_value">0.00</span>
									<span class="o_stat_text"></span>
								</div> <?php echo _l('mrp_Minutes'); ?></span><span class="o_stat_text"><?php echo _l('mrp_Load'); ?></span></div></button><button type="button" name="243" class="btn oe_stat_button" context="{'search_default_workcenter_id': id, 'search_default_thisyear': True}"><i class="fa fa-fw o_button_icon fa-bar-chart"></i><div class="o_field_widget o_stat_info"><span class="o_stat_value"><div name="performance" class="o_field_widget o_stat_info o_readonly_modifier" data-original-title="" title="">
									<span class="o_stat_value">0</span>
									<span class="o_stat_text"></span>
								</div>%</span><span class="o_stat_text"><?php echo _l('mrp_Performance'); ?></span></div></button>
							</div>
