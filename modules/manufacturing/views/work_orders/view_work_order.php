...
<div id="wrapper">
	<div class="content">
							...
							<div class="tab-content">
								...
								<div class="row">
									<div class="horizontal-scrollable-tabs preview-tabs-top">
										...
										<div class="horizontal-tabs">
											<ul class="nav nav-tabs nav-tabs-horizontal mbot15" role="tablist">
												...
												<?php hooks()->do_action('after_manufacturing_work_order_tab', $work_order); ?>
											</ul>
										</div>
									</div>
									<br>
									...
									<div class="tab-content active">
										<?php hooks()->do_action('after_manufacturing_work_order_tab_content', isset($work_order) ? $work_order : false); ?>
		...
		?>
		<?php hooks()->do_action('mrp_work_order_load_js', isset($work_order) ? $work_order : false); ?>
	</body>
	</html>
