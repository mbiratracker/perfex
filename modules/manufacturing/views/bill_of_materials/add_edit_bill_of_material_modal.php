				...
				<div class="tab-content">
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="col-md-12">
								<?php echo render_select('product_id',$parent_product,array('id',array('commodity_code', 'description')),'product_label',''); ?>
							</div>
							<div class="col-md-12">
								<?php echo render_select('product_variant_id',$parent_product,array('id',array('commodity_code','description')),'product_variant',''); ?>
