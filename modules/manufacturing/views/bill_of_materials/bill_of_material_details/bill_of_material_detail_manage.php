					...
					<div class="panel_s">
						...
						<div class="panel-body">
							...
							<div class="row">
								...
								<div class="col-md-12">
									<?php echo render_select('product_id',$parent_product,array('id',array('commodity_code', 'description')),'product_label', $product_id); ?>
								</div>
								<div class="col-md-12">
									<?php echo render_select('product_variant_id',$product_variant,array('id',array('commodity_code', 'description')),'product_variant', $product_variant_id); ?>
								...
								<div class="col-md-6">
									<?php echo render_select('routing_id',$routings,array('id', ['routing_code','routing_name']), 'routing_label', $routing_id,[], [], '', '' , true); ?>
								</div>
