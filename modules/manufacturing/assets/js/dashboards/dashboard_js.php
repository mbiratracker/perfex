<script>
	...
	function report_by_manufacturing_order(id, value, title_c){
       ...
       Highcharts.setOptions({
	       	lang: {
	        contextButtonTitle: '<?php echo _l('mrp_contextButtonTitle'); ?>',
	        downloadJPEG: '<?php echo _l('mrp_downloadJPEG'); ?>',
	        downloadPDF: '<?php echo _l('mrp_downloadPDF'); ?>',
	        downloadPNG: '<?php echo _l('mrp_downloadPNG'); ?>',
	        downloadSVG: '<?php echo _l('mrp_downloadSVG'); ?>',
	        printChart: '<?php echo _l('mrp_printChart'); ?>'
	    },
       	chart: {
       		style: {
       ...
       Highcharts.chart(id, {
       	...
       	series: [{
       		name: '<?php echo _l('mrp_draft'); ?>',
       		data: response.draft 

       	}, {
       		name: '<?php echo _l('mrp_planned'); ?>',
       		data: response.planned

       	},{
       		name: '<?php echo _l('mrp_cancelled'); ?>',
       		data: response.cancelled

       	},{
       		name: '<?php echo _l('mrp_confirmed'); ?>',
       		data: response.confirmed

       	},{
       		name: '<?php echo _l('mrp_done'); ?>',
       		data: response.done

       	}, {
       		name: '<?php echo _l('mrp_in_progress'); ?>',
